...
@Test    
Scenario: TC18_Verification of copy pasting numeric digits in Contact Number field  of User Add screen by Super Admin/Admin user
Given User launch application in chrome browser
When user enters credentials and click on login button
Then Click on Settings module from side menu bar
Then verify add button on user list page
...
@Test    
Scenario: TC19_Verification of the rejection of blanks and spaced number in Contact Number field  of User Add screen by Super Admin/Admin user
Given User launch application in chrome browser
When user enters credentials and click on login button
Then Click on Settings module from side menu bar
Then verify add button on user list page
...
Then Click on Users tab from right panel of the screen
Then verify add button on user list page
Then verify error message without entering details in Add new Screen
...
Then Click on Users tab from right panel of the screen
Then verify add button on user list page
Then verify error message entering invalid details for first name 
...
@Test    
Scenario: TC189_Add user functionality test under user sub module setting page
Given User launch application in chrome browser
When user enters credentials and click on login button
Then Click on Settings module from side menu bar
Then Click on Users tab from right panel of the screen

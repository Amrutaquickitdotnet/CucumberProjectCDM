...
#
#@Test
#Scenario: TC049_Verification of entering the onboarding key in Registration section in Add screen of EDGE Device module by Super admin/Admin user
#Given User launch application in chrome browser
#And user enters credentials and click on login button
#Then Click on EDGE Device module from side menu bar
#And After landing on EDGE Device List screen
...
#Then Click on Deployments tab
#And Click on Environment Variable
#And Click on search icon of configName
...
#And Click on Environment Variable
#And Click on search icon of configName 
#And Click on search icon of configValue 
#
#@Test
...
#
#@Test
#Scenario: TC090_Verification of Update functionality in the EDGE Device List screen by Super admin/Admin user
#Given User launch application in chrome browser
#When user enters credentials and click on login button
#Then Click on EDGE Device module from side menu bar
#Then Click on EDGE ID name search icon i.e. three dots & enter Valid inputs into search text field

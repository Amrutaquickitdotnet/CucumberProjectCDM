...
#
    ...
    @Test
    Scenario: TC18_Verification_logging_valid_credentials_multipleTab
    Given User launch application in chrome browser   
    When user enters valid userid
    And user enters valid password     
    And Enter on login button    
    ...
    And Succesfull login should be happen
     ...
     #@Test
    #Scenario: TC19_Verification_logging_valid_credentials_admin/admin
    #Given User launch application in chrome browser    
    #When user enters valid userid
    #And user enters valid password     
    #And Enter on login button    
    ...
    #
     ...
     #@Test
    #Scenario: TC20_Verification_accepeteance _alphanumeric_values s_admin/admin
    #Given User launch application in chrome browser   
    #When user enters valid userid
    #And user enters valid password     
    #And Enter on login button    

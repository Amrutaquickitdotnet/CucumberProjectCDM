...
@Test
Scenario: TC44_Verification of selection of the from Delink Edge Group drop down in the Configuration section of User Add screen by Super admin/Admin user
Given User launch application in chrome browser
When user enters credentials and click on login button
And Click on EDGE Group module from side menu bar
Then Click on the three dots of GroupName

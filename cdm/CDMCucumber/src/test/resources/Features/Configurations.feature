...
@Test
Scenario: TC08_Verification of tooltip functionality for Refresh button of the Configurations List screen by Super admin/Admin user
Given User launch application in chrome browser
When user enters credentials and click on login button
Then Click on Configurations module from side menu bar
Then verify tooltip for the refresh button
...
@Test
Scenario: TC29_Verification of the removal of search results and text for Last Updated columns in the Configurations screen by Super admin/Admin user
Given User launch application in chrome browser
When user enters credentials and click on login button
Then Click on Configurations module from side menu bar
Then Click on LastUpdatedThreeDotSearch icon and enter the value in datepickercolumn and clear field

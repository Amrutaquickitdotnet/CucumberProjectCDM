...
#
#@Test
#Scenario: TC18_Verification of the search functionality for Edge Name column (Invalid Edge Name) in the Deployment List screen by Super admin/Admin user
#Given User launch application in chrome browser
#When user enters credentials and click on login button
#Then Click on Deployments module from side menu bar
#Then Click on the Current View button
...
#When user enters credentials and click on login button
#Then Click on Deployments module from side menu bar
#Then Click on App Name Group search icon i.e. three dots & enter Valid inputs into search text field
#
#
#@Test
